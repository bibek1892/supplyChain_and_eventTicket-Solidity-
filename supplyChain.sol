...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
   ...
   */
   modifier forSale (uint256 _sku) {
      ...
      require(items[_sku].state == State.ForSale,"Item is for selling.....");
      _;
     }
  ...
  modifier shipped(uint256 _sku){
      ...
      require(items[_sku].state == State.Shipped,"Item is being shpped.....");
      _;
  ...
  modifier received(uint256 _sku){
      ...
      require(items[_sku].state == State.Received,"Item is  being received.....");
        _;
